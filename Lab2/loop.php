...
if(isset($_GET['numberfield']) && isset($_GET['math']) )
{
    ...
    {
        echo"The sum of numbers between 1 and $number is: &nbsp".sum($number);
    }
...
{
    if($number > 170){return "Can't calculate factorial above 171";} //This function can only calculate the factorial of numbers below 171
